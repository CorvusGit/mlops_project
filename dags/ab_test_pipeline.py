...
# Настройки DAG
with DAG(
    dag_id="ab_test_last_and_best_models",
    start_date=datetime(year=2026, month=6, day=2),
    ...
    poke_spark_processing = DataprocCreatePysparkJobOperator(
        ...
        main_python_file_uri=f"s3a://{S3_SRC_BUCKET}/src/ab_test.py",
        python_file_uris=[
            f"s3a://{S3_SRC_BUCKET}/src/common_functions.py",
            f"s3a://{S3_SRC_BUCKET}/src/ml_functions.py"
        ],
        connection_id=YC_SA_CONNECTION.conn_id,
