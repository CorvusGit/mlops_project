...
with DAG(
    ...
    create_spark_cluster = DataprocCreateClusterOperator(
        ...
        cluster_name=f"tmp-clean-dp--{uuid.uuid4()}",
    ...
    poke_spark_processing = DataprocCreatePysparkJobOperator(
        ...
        main_python_file_uri=f"s3a://{S3_SRC_BUCKET}/src/clean_data3.py",
        python_file_uris=[
            f"s3a://{S3_SRC_BUCKET}/src/common_functions.py"
            ],
        connection_id=YC_SA_CONNECTION.conn_id,
        args=["--in-path", f"s3a://{S3_BUCKET_NAME}/input_data/",
            "--out-path", f"s3a://{S3_BUCKET_NAME}/output_data/",
